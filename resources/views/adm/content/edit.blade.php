  ...
  {{ csrf_field() }}
  	<div class="row">
          <div class="file-field input-field col s12 right hide">
            ...
            @endif
    				{!!Form::text('',$data->image1, ['placeholder' => trans('translator.main-image-empresa'), 'class'=>'file-path validate', 'required', 'style' => 'padding-left: 40px;']) !!}
    			</div>
    		</div>
        <div class="file-field input-field col m8 s12">
    			<div class="btn">
            ...
            @endif
    				{!!Form::text('',$data->image2, ['placeholder' => trans('translator.main-image-empresa'), 'class'=>'file-path validate', 'required', 'style' => 'padding-left: 40px;']) !!}
    			</div>
    		</div>
        <div class="file-field input-field col m8 s12">
    			<div class="btn">
            ...
            @endif
    				{!!Form::text('',$data->image3, ['placeholder' => trans('translator.main-image-empresa'), 'class'=>'file-path validate', 'required', 'style' => 'padding-left: 40px;']) !!}
    			</div>
    		</div>
