		...
		<table class="highlight bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						{!! $dat->code !!}
						<a href="{{ route('item_gallery.show', ['id' => $dat->id]) }}" class="btn-floating btn-medium waves-effect waves-light blue ml-3x"><i class="far fa-images"></i></a>
					</td>
					<td>{!! $dat->title_es !!}</td>
					<td>{!! $dat->order !!}</td>
					<td class="right">
